...
class SeekPreviewRepositoryTest {
  @Test
  fun `frame count stays bounded and grows for long media`() {
    assertEquals(24, SeekPreviewRepository.frameCount(60f))
    assertEquals(24, SeekPreviewRepository.frameCount(3600f))
    assertEquals(64, SeekPreviewRepository.frameCount(20_000f))
  }

  @Test
  fun `sample positions cover the complete timeline`() {
